...
def add_poster(df):
    for i,row in tqdm(df.iterrows(),total=df.shape[0]):
        ...
        try:
            ...
            df.at[i,"poster_path"] = "https://image.tmdb.org/t/p/original/uXDfJbP4ijW5jWSBrPrlKpxab.jpg"
    return df
...
if(__name__=="__main__"):
    ...
    result_df.to_csv("data/movies_final.cvs",index=None)
